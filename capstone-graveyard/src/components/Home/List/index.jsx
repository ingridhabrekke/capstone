	...
	return (
		<div className="">
			...
			<div className="container max-h-80 justify-start ">
				...
				{
					entries?.map((entry, i) => (
						<div key={i} className="mb-5 mt-5 block h-32 shadow-md rounded-md border bg-white border-gray-300 m-8">
										...
										<div className="space-y-5"  >
											...
											<div className="mt-4">
												...
												{colleges.map((name, index) => {
													return (
														<div key={index} className="container inline pl-2">
																	<input
																		type="checkbox"
																	...
																	/>
																	<label className="p-1" htmlFor={`custom-checkbox-${index}`}>{name}</label>
														</div>
